...
describe('popOver', function () {
  ...
  describe('props', function () {
    it('popover 可以设置 position', function () {
    ...
    xit('popover 可以测试 trigger', function (done) {
      _vue.default.component('g-popover', popOver);
      ...
      var popOver = vm.$refs.a; // console.log(popOver.$el)
      // mouseenter没法像click一样直接button.click()

      var event = new Event('mouseenter');
      var button = popOver.$el.querySelector('button');
