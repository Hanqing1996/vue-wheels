...
_vue.default.component('g-button-group', _buttonGroup.default); // describe 和 it 來自 mocha


describe('Button', function () {
  it('存在.', function () {
    expect(_button.default).to.be.ok; // 不是假值，就不报错
  });
...
},{"vue":"../node_modules/vue/dist/vue.common.js","../src/button":"../src/button.vue","../src/icon":"../src/icon.vue","../src/button-group":"../src/button-group.vue"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
var global = arguments[3];
