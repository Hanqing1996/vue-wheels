...
describe('Row and Col', function () {
  it('存在.', function () {
    expect(_row.default).to.exist;
    expect(_col.default).to.exist;
  });
  describe('props', function () {
    it('row 和 col 接收 gutter', function (done) {
      ...
      setTimeout(function () {
        ...
        expect(getComputedStyle(row).marginLeft).to.eq('-10px'); // 测试 col

        var col = vm.$el.querySelector('.col');
    ...
    it('col 接受 span,offset', function () {
      var div = document.createElement('div');
      document.body.appendChild(div);
