...
!function (i) {
  ...
  !function (t) {
    ...
    } else document.attachEvent && (c = t, a = i.document, o = !1, (_n = function n() {
      try {
...
_vue.default.component('g-button-group', _buttonGroup.default); // new Vue 和组件注册没有任何关系
