...
// npx parcel index.html 打开浏览器并执行以下测试用例
_chai.default.use(_chaiSpies.default); // 所有组件在这里注册，注意 loadingStatus1,loadingStatus2 属于new的Vue例的data对象，不属于以下组件的data函数
...
_vue.default.component('g-button-group', _buttonGroup.default); // 全局注册意味着：这三个组件在各自内部也都可以相互使用。
